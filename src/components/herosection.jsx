...
const Herosection = () => {
    return (
        <div className="h-[93vh] font-po flex justify-center items-center px-16 relative overflow-hidden">
            <img src="/public/Images/Rings.png" alt="Rings" className="absolute bottom-5 -right-36 z-0 " />
            <img src="/public/Images/Rings.png" alt="Rings" className="absolute -top-24 -left-40 z-0 rotate-180" />
